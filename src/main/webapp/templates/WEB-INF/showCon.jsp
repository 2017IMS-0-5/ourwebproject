...
<head>
    ...
    <style type="text/css">
        ...
        /** 右侧标题展示 **/
        .bg3_2{ width: 75%;padding-top: 35px; float: left;margin:0;}
        .bg3_2:after{content: "";display: block;height: 0;visibility: hidden;clear: both;}
        .bg4{width: 90%;padding-top:20px;padding-bottom:30px;background-color: #c6d5f2;margin: 0}
        .bg4 table{width: 89%;border-collapse:collapse;}
        .bg4_tr1{height: 40px;width:80%;border-bottom: 2px solid darkblue;}
        ...
        <div class="bg4">
            <table align="center" valign="middle">
                <tr class="bg4_tr1">
                    ...
                    <th class="bg4_th2">当前位置：<a href="/info/main">首页</a>/<a href="/info/qtxx">就业信息</a>/正文 </th>
                </tr>
            </table>
            <div class="bg5">

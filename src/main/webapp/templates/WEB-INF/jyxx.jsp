...
<head>
    ...
    <style type="text/css">
        ...
        .bg2_2{height: 85%;width: 100%;;margin:0;background-color: white;}

        /** 左侧导航**/
        .bg3_1{width: 25%; height: 100%;padding-left: 15px;padding-top: 35px;float: left;margin:0
        }
        :focus { outline: 1; }
        ...
        ul { width: 190px; margin: 0 auto; background-color: #f2f2f2; position: relative; padding: 0; }
        ...
        /** 右侧标题展示 **/
        .bg3_2{width: 68%; height: 100%;padding-top: 30px;float: left;margin:0;}
    ...
    <div class="bg2_2">
        ...
        <div class="bg3_2">
            <div class="bg4_1">
                <table>
                    <tr>
                        <td class="bg4_1_td1">就业信息</td>
                        <td class="bg4_1_td2">当前位置：<a href="/index">首页</a>/就业信息 </td>
                    </tr>
                </table>
            </div>
            <div class="bg4_2">

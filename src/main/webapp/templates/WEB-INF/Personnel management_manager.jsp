            ...
            <form>
                ...
                <div class="search1" style="margin:5px 7px;">
                    <select name="role" style="float:left;border-radius:5px;" id="role">
                        <option value="userByAdminAnd" selected="selected">管理员</option>
                        <option value="userBySAdminAnd">超级管理员</option>
                    </select>
                </div>
                ...
                <div class="search1" style="margin:5px 7px;">
                    <select name="searchWay" style="float:left;border-radius:5px;" id="indexitem">
                        ...
                        <option value="Role">按身份检索</option>
                ...
                <div class="search1" style="margin:4px 10px;">
                    <input type="button" value="导入" class="button" >
                </div>
            </form>
        </div>
            ...
            <table class="managetable">
                    ...
                    <c:forEach var="adm" items="${adminList}">
                        <tr class="detailinfor">
                            ...
                            <td>
                                <p><a class="changeinfo">修改</a>/<a href="${pageContext.request.contextPath}/admin/adminDelete?id=${adm.id}">删除</a></p>
                            </td>
                        </tr>
                    </c:forEach>
            </table>

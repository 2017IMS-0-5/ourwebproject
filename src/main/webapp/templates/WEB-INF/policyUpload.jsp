	...
	<div class="noteuploadzone">
		<form action="/admin/tzggsubmit" method="get" class="form" onsubmit="deal()">
            <dl id="li" class="list">
                ...
                <dt class="items">
                    <label>文件类别:</label><input type="text" name="field" value="政策制度" contenteditable="false" class="uploadinput">
                </dt>
                <dt class="items">
                    <label>文件主题:</label>
            ...
            <dt class="items" style="margin-bottom: 60px;">
                <label style="vertical-align: top;">文件摘要：</label><textarea name="content" class="abs"></textarea>
            </dt>
